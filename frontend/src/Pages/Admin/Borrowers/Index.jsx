...
const Borrowers = () => {
  return (
    <div className="p-4 sm:p-6">
      ...
      <h1 className="text-lg sm:text-xl font-semibold mb-4">Borrowers List</h1>
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center mb-4 gap-3 sm:gap-0">
          ...
          <div className="relative w-full sm:w-auto">
            ...
            <input
              ...
              className="pl-10 pr-4 py-2 rounded-full border border-gray-300 bg-gray-50 w-full sm:w-64 text-sm" // Full width on mobile
            />
            <svg
